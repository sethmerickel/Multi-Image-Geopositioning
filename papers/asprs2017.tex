...
\bibitem{PLANE_COLLINS}Collins, R.~T., ``A space-sweep approach to true
...
\bibitem{LRO_NINE}Di, K., B.~Xu, B.~Liu, M.~Jia, Z.~Liu, ``Geopositioning
...
\bibitem{JEONG_SIX}Jeong, Jaehoon, Chansu Yang, Taejung Kim, ``Geo-positioning
...
\bibitem{WONNACOT_32_3}Wonnacot, W.~M., {\em Geolocation with Error Analysis
