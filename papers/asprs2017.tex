...
Orbiter. Wonnacott \cite{WONNACOTT_32_3} analyzes MIG accuracy with SAR, using 32
...
parametrs are given sigmas of $\sigma = 1{\mathrm m}, 0.1{\mathrm m}/{\mathrm s},
0.01{\mathrm m}^2/{\mathrm s}^2$, and 9 attitude/rate/acceleration parameters
are given sigmas of
$\sigma=5\mu\mathrm{rad}, 0.5\mu\mathrm{rad}/{\mathrm s}, 
0.05\mu\mathrm{rad}/{\mathrm s}^2$.
...
\bibitem{FRESNO}Settergren, R., S.~Merickel and S.~Walker, 2017. Reducing
  geopositioning error with large numbers of images, 2017 Geomatics Engineering
  Conference, Fresno, CA, 27 Jan 2017. 79 slides, available online \cite{GITHUB}
...
\bibitem{WONNACOTT_32_3}Wonnacott, W.~M., 2008. {\em Geolocation with Error Analysis
